...
- **Serveur MCP sur un Spark** : piste étudiée le 2026-09-02 et laissée hors
  backlog par arbitrage du responsable. Le besoin, les décisions prises et les
  raisons sont conservés dans `docs/EXPLORATION_MCP.md`, qui n'est ni une
  spécification ni un contrat. Aucun identifiant n'est réservé.
